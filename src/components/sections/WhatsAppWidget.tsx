// src/components/sections/WhatsAppWidget.tsx
'use client'
...
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hello! I'd like to enquire about your auto services."
)
...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="whatsapp-widget">
        ...
        <div className="whatsapp-popup animate-fade-in-up">
          <div className="whatsapp-popup-header">
            ...
            <div className="whatsapp-popup-info">
              <p className="whatsapp-popup-name">SEAA Auto Services</p>
              <p className="whatsapp-popup-status">
                <span className="whatsapp-status-dot" /> Typically replies instantly
              </p>
            </div>
          ...
          <div className="whatsapp-popup-body">
            <div className="whatsapp-chat-bubble">
              ...
              <p style={{ marginTop: '0.5rem' }}>We offer:</p>
          ...
          <div className="whatsapp-popup-footer">
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="whatsapp-start-btn">
      ...
      <button
        className={`whatsapp-toggle ${!isOpen ? 'bounce' : ''}`}
