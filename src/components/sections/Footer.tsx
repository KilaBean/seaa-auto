        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-description">
              ...
              Alignment, Vulcanizing, AC Services, and Auto Diagnostics. Quality service at fair
              prices.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li className="footer-contact-item">
                ...
                <a href="tel:+233123456789" className="footer-phone">
                  +233 XX XXX XXXX
                </a>
              </li>
              <li className="footer-contact-item">
                <Mail className="footer-contact-icon" />
                <a href="mailto:info@seaaauto.com" className="footer-link">
                  info@seaaauto.com
                </a>
              </li>
              <li className="footer-contact-item">
